...
public class DomainEventPublisher implements ApplicationListener<DomainEvent.Message> {
    ...
    @Inject
    public DomainEventPublisher(final KafkaGateway eventPublisher, final EntityManager entityManager, @Value("${eventing.scheduler.enabled}") boolean schedulerEnabled) {
