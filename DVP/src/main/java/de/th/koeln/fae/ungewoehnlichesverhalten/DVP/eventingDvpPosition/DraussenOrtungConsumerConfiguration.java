...
import de.th.koeln.fae.ungewoehnlichesverhalten.DVP.infrastructure.eventing.configuration.SimpleConsumerTopicConfig;
...
@Configuration
@EnableKafka
public class DraussenOrtungConsumerConfiguration {

    @Bean
    @ConfigurationProperties(prefix = "draussenOrtung")
    public ConsumerTopicConfig draussenOrtungTopicConfig() {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> kafkaListenerContainerFactory() {
        ...
        factory.getContainerProperties().setAckMode(ContainerProperties.MANUAL_IMMEDIATE);
